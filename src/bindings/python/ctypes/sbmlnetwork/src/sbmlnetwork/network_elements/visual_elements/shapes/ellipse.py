...
class Ellipse(ShapeBase):
    ...
    def set_relative_center(self, center: tuple[float, float]):
        if self.sub_element_index is None:
            ...
            if self.libsbmlnetwork.setSpeciesReferenceLineEndingGeometricShapeCenterX(id=self.element_id, graphical_object_index=self.graphical_object_index, species_reference_index=self.sub_element_index, geometric_shape_index=self.geometric_shape_index, x=center[0]) == 0 and \
                    self.libsbmlnetwork.setSpeciesReferenceLineEndingGeometricShapeCenterY(id=self.element_id, graphical_object_index=self.graphical_object_index, species_reference_index=self.sub_element_index, geometric_shape_index=self.geometric_shape_index, y=center[1]) == 0:
                return True
