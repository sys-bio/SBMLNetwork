...
namespace LIBSBMLNETWORK_CPP_NAMESPACE  {
    ...
    int autolayout(SBMLDocument* document, const int maxNumConnectedEdges, bool useNameAsTextLabel, bool resetLockedNodes, std::set<std::pair<std::string, int> > lockedNodesSet) {
