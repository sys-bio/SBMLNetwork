...
class SBGNProduction(SBGNConnectingArcBase):

    def __init__(self, element_id, source_id, target_id, start_x, start_y, end_x, end_y, intermediate_points=None, sub_elements=None):
        super(SBGNProduction, self).__init__(element_id, source_id, target_id, start_x, start_y, end_x, end_y, intermediate_points, sub_elements)
    ...
    def set_geometric_shape_features(self, sbmlnetwork_object, reaction, species):
        super(SBGNProduction, self).set_geometric_shape_features(sbmlnetwork_object, reaction, species)
        ...
        sbmlnetwork_object.libsbmlnetwork.setSpeciesReferenceLineEndingBorderColor(reaction.get_id(), border_color="black",
                                                                  species_reference_index=species_reference_index)
        sbmlnetwork_object.libsbmlnetwork.setSpeciesReferenceLineEndingFillColor(reaction.get_id(), fill_color="black",
                                                                 species_reference_index=species_reference_index)
