...
class SBGNNucleicAcidFeature(SBGNEntityPoolNodeBase):
    ...
    def add_geometric_shape(self, sbmlnetwork_object, parent_element):
        ...
        sbmlnetwork_object.libsbmlnetwork.setGeometricShapeSegmentX(parent_element.get_id(), 0.0, segment_index=0,
                                                     geometric_shape_index=geometric_shape_index)
        ...
        sbmlnetwork_object.libsbmlnetwork.setGeometricShapeSegmentY(parent_element.get_id(),
                                                     ...
                                                     geometric_shape_index=geometric_shape_index)
        sbmlnetwork_object.libsbmlnetwork.setGeometricShapeSegmentX(parent_element.get_id(), (
                1 - 0.5 * (1.0 / math.sqrt(2)) * horizontal_edge_ratio) * sbmlnetwork_object.libsbmlnetwork.getWidth(
            parent_element.get_id()), segment_index=3, geometric_shape_index=geometric_shape_index)
        sbmlnetwork_object.libsbmlnetwork.setGeometricShapeSegmentY(parent_element.get_id(), (
                1 - 0.5 * (1.0 / math.sqrt(2)) * vertical_edge_ratio) * sbmlnetwork_object.libsbmlnetwork.getHeight(
            parent_element.get_id()), segment_index=3, geometric_shape_index=geometric_shape_index)
        sbmlnetwork_object.libsbmlnetwork.setGeometricShapeSegmentX(parent_element.get_id(),
        ...
        sbmlnetwork_object.libsbmlnetwork.setGeometricShapeSegmentX(parent_element.get_id(), 0.5 * horizontal_edge_ratio * (
                1.0 / math.sqrt(2)) * sbmlnetwork_object.libsbmlnetwork.getWidth(parent_element.get_id()), segment_index=6,
                                                     geometric_shape_index=geometric_shape_index)
        sbmlnetwork_object.libsbmlnetwork.setGeometricShapeSegmentY(parent_element.get_id(), (
                1 - 0.5 * (1.0 / math.sqrt(2)) * vertical_edge_ratio) * sbmlnetwork_object.libsbmlnetwork.getHeight(
